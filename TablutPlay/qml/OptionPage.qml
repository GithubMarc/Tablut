    ...
    Item {
        ...
        /*FolderListModel {
            ...
            Component.onCompleted: {
                var temp = folderModel.get(0, "fileBaseName");
        ...
        ComboBox {
            ...
            width: 200
            //onCurrentIndexChanged: console.debug(cbItems.get(currentIndex).text + ", " + cbItems.get(currentIndex).color + ", " + cbItems.get(currentIndex).path)
        }
